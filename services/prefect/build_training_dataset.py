...
def main():
    ...
    # Définition de la liste des features à récupérer
    features = [
    ...
    # Récupération historique avec Feast (Point-in-time join)
    ...
    df = training_df.merge(labels_df, on=["user_id", "event_timestamp"], how="inner")
